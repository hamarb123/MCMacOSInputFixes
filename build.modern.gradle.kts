...
sourceSets {
	named("client") {
		java {
			...
			exclude("com/hamarb123/macos_input_fixes/client/mixin/gui/MouseSettingsScreenMixin6.java")
			exclude("com/hamarb123/macos_input_fixes/client/mixin/gui/MouseSettingsScreenMixin9.java")
			exclude("com/hamarb123/macos_input_fixes/client/mixin/gui/OptionsListMixin9.java")
			exclude("com/hamarb123/macos_input_fixes/client/mixin/gui/ScreenAccessor7.java")
			exclude("com/hamarb123/macos_input_fixes/client/mixin/InventoryMixin10.java")
			exclude("com/hamarb123/macos_input_fixes/client/mixin/KeyboardHandlerMixin12.java")
			exclude("com/hamarb123/macos_input_fixes/client/mixin/MinecraftMixin12.java")
			exclude("com/hamarb123/macos_input_fixes/client/mixin/MouseHandlerMixin12.java")
			exclude("com/hamarb123/macos_input_fixes/client/mixin/ScreenMixin12.java")
		}
	}
}
